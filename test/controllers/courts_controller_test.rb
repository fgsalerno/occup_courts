...
class CourtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create court" do
    assert_difference('Court.count') do
      post courts_url, params: { court: { nombre: @court.nombre, observacion: @court.observacion } }
    end
  ...
  test "should update court" do
    patch court_url(@court), params: { court: { nombre: @court.nombre, observacion: @court.observacion } }
