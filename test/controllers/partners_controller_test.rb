...
class PartnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post partners_url, params: { partner: { desc: @partner.desc, partner_state_id: @partner.partner_state_id, person_id: @partner.person_id } }
    end
  ...
  test "should update partner" do
    patch partner_url(@partner), params: { partner: { desc: @partner.desc, partner_state_id: @partner.partner_state_id, person_id: @partner.person_id } }
